...
def plot_tetrode(clufile):
    """
    This function creates a figure with multiple graphs in a grid format. 
    The number of graphs and dimensions of the grid depend on the number of clusters 
    within each tetrode. 

    Paramater: a clufile for a specific tetrode
